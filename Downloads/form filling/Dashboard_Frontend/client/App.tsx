    ...
    <div className="flex min-h-screen bg-[#f4f0ff] text-text-primary">
      <aside className="w-64 bg-card text-text-primary flex flex-col fixed top-0 left-0 h-full shadow-xl z-30 border-r border-border-color overflow-y-auto">
        ...
        <div className="p-3 border-t border-border-color space-y-3">
          {/* Direct language selector buttons */}
          <div className="flex justify-between items-center bg-card p-2 rounded-md shadow-sm">
            ...
            <div className="flex space-x-2">
              <button 
                ...
                className={`px-2 py-1 text-xs font-medium rounded ${currentLanguage === 'en' ? 'bg-accent text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
              >
                EN
              </button>
              <button 
                onClick={() => handleLanguageChange('es')} 
                className={`px-2 py-1 text-xs font-medium rounded ${currentLanguage === 'es' ? 'bg-accent text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
              >
                ES
              </button>
              <button 
                onClick={() => handleLanguageChange('de')} 
                className={`px-2 py-1 text-xs font-medium rounded ${currentLanguage === 'de' ? 'bg-accent text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
              >
                DE
              </button>
            </div>
