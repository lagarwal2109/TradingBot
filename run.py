...
from bot.engine_hybrid import HybridTradingEngine
...
def main():
    ...
    parser.add_argument(
        "--mode",
        choices=["trade", "collect", "sharpe", "tangency", "enhanced", "hybrid"],
        default="enhanced",
        help="Operating mode: hybrid (recommended), enhanced, sharpe, tangency, or collect data"
    )
    parser.add_argument(
        "--window",
        type=int,
    ...
    try:
        ...
        if args.mode == "hybrid":
            # Use hybrid trading engine with adaptive strategy
